...
class CreateTicketFragment : Fragment() {
    ...
    companion object {
        ...
        private const val TICKET_API_URL = "http://62.72.59.119:8000/api/ticket/create"
        private const val FEEDER_LIST_URL = "http://62.72.59.119:8000/api/feeder/list"

        private const val CATEGORY_API_URL = "http://62.72.59.119:8000/api/feeder/categories"
