    ...
    class ViewHolder(
        ...
        fun bind(data: FeederHourlyData, position: Int) {
            binding.apply {
                ...
                // Set hourly values with SIMPLIFIED status colors (00-23)
                setHourValueSimple(etHour00, data.hourlyValues["01"])
                setHourValueSimple(etHour01, data.hourlyValues["02"])
                setHourValueSimple(etHour02, data.hourlyValues["03"])
                setHourValueSimple(etHour03, data.hourlyValues["04"])
                setHourValueSimple(etHour04, data.hourlyValues["05"])
                setHourValueSimple(etHour05, data.hourlyValues["06"])
                setHourValueSimple(etHour06, data.hourlyValues["07"])
                setHourValueSimple(etHour07, data.hourlyValues["08"])
                setHourValueSimple(etHour08, data.hourlyValues["09"])
                setHourValueSimple(etHour09, data.hourlyValues["10"])
                setHourValueSimple(etHour10, data.hourlyValues["11"])
                setHourValueSimple(etHour11, data.hourlyValues["12"])
                setHourValueSimple(etHour12, data.hourlyValues["13"])
                setHourValueSimple(etHour13, data.hourlyValues["14"])
                setHourValueSimple(etHour14, data.hourlyValues["15"])
                setHourValueSimple(etHour15, data.hourlyValues["16"])
                setHourValueSimple(etHour16, data.hourlyValues["17"])
                setHourValueSimple(etHour17, data.hourlyValues["18"])
                setHourValueSimple(etHour18, data.hourlyValues["19"])
                setHourValueSimple(etHour19, data.hourlyValues["20"])
                setHourValueSimple(etHour20, data.hourlyValues["21"])
                setHourValueSimple(etHour21, data.hourlyValues["22"])
                setHourValueSimple(etHour22, data.hourlyValues["23"])
                setHourValueSimple(etHour23, data.hourlyValues["24"])
